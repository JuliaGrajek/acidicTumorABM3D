...
%    myColr(1,:) = getColorModelTopo(colordata.DISTANT_OUT,colornorm);
...
% prepare colors
myColr(2,:) = getColorModelTopo(colordata.MARG_500_OUT,colornorm);   % outer margin
myColr(3,:) = getColorModelTopo(colordata.MARG_500_IN,colornorm);   % inner margin
myColr(4,:) = getColorModelTopo(colordata.TU_CORE,colornorm);   % core
...
%     myColr(5,:) = getColorModelTopo(colordata.MARG_LUM,colornorm);   % core
%     i = 5; rct(pos(i,:),myColr(i,:),myEdge(i),myCurv(i,:),1);
% end

% add title
text(xbase,ybase+4,strrep(mytitle,'_','-'),'VerticalAlignment','bottom','HorizontalAlignment','center','FontWeight','normal');
...
%     
%     % prepare fat colors
%     myColrF(1,:) = getColorModelTopo(colordata.FAT_MARG_OUT,colornorm);   % outer margin
%     myColrF(2,:) = getColorModelTopo(colordata.FAT_MARG_IN,colornorm);   % inner margin
%     myColrF(3,:) = getColorModelTopo(colordata.FAT_CORE,colornorm);   % core
% 
%     numdraw = 3;
%     for i=1:numdraw
